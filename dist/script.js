...
var drop = function drop() {
  ...
  function highlight(item) {
    item.closest('.file_upload').style.borded = "5px solid yellow";
    item.closest('.file_upload').style.backgroundColor = "rgba(0,0,0, .7)";
  }

  function unhighlight(item) {
    item.closest('.file_upload').style.borded = "none";
  ...
  fuleInputs.forEach(function (input) {
...
var pictureSize = function pictureSize(imgSelector) {
  ...
  function showImg(block) {
    ...
    block.querySelectorAll('p:not(.size-hit)').forEach(function (p) {
